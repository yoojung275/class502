...
public class Ex03 {
    ...
    void test2() {
        ...
        /* 커넥션 풀 설정 S*/
        ds.setInitialSize(2); //로드 초기에 생성할 연결 객체 수 - 기본값 10개
        ds.setMaxActive(10); //최대 생성할 연결 객체 수 - 기본값 100개
        ds.setTestWhileIdle(true); //연결 객체가 유휴 상테일 때 연결상태 체크
        ds.setTimeBetweenEvictionRunsMillis(5 * 1000); //5초에 한벅씩 연결 상태 체크
